...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class FlipperLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>flipper</b> with <b>com.facebook.flipper:flipper</b> coordinates and
         * with version reference <b>flipper</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> asProvider() {
            return create("flipper");
        }

        /**
         * Group of libraries at <b>flipper.fresco</b>
         */
        public FlipperFrescoLibraryAccessors getFresco() {
            return laccForFlipperFrescoLibraryAccessors;
        }

        /**
         * Group of libraries at <b>flipper.network</b>
         */
        public FlipperNetworkLibraryAccessors getNetwork() {
            return laccForFlipperNetworkLibraryAccessors;
        }
    ...
    public static class FlipperFrescoLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>plugin</b> with <b>com.facebook.fresco:flipper-fresco-plugin</b> coordinates and
         * with version reference <b>fresco</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getPlugin() {
            return create("flipper.fresco.plugin");
        }
    ...
    public static class FlipperNetworkLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>plugin</b> with <b>com.facebook.flipper:flipper-network-plugin</b> coordinates and
         * with version reference <b>flipper</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getPlugin() {
            return create("flipper.network.plugin");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>agp</b> with value <b>8.1.1</b>
         * <p>
        ...
        /**
         * Version alias <b>fbjni</b> with value <b>0.5.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>flipper</b> with value <b>0.201.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>fmt</b> with value <b>6.2.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>folly</b> with value <b>2022.05.16.00</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>libevent</b> with value <b>2.1.12</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
