...
var esMX = {
  ...
  unstable__errors: {
    ...
    form_identifier_not_found: "No se encontr\xF3, puede estar mal escrito.",
    ...
    zxcvbn: {
      ...
      warnings: {
        ...
        commonNames: "Nombre y apellidos comunes son f\xE1ciles de adivinar.",
        ...
        namesByThemselves: "Nombres o apellidos a solas son f\xE1ciles de adivinar.",
  ...
  userProfile: {
    ...
    deletePage: {
      actionDescription: 'Escribe "Delete account" a continuaci\xF3n para continuar',
